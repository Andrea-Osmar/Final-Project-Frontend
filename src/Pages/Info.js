  ...
  return (
    <section className='info-wrapper'>
      <div className='info-container'>
        ...
        <p className='info-details'>Fonts are from <a href='https://fonts.google.com/'>Google Fonts</a></p>
      </div>

        <div className='info-container'>
          <h1 className='info-header'> Developed by: Andrea Osmar</h1>
          <p className='info-text'>Hi, I'm Andrea. I am a newly graduated Frontend developer 
            with a background in the Hospitality industry. 
            I enjoy creating and designing websites mainly in React.
            check out my 
          <a href='https://andreaosmar.netlify.app/'>Portfolio</a></p>
          <div className='info-icons-wrapper'>
          <span className='info-icons'><a href="https://www.linkedin.com/in/andrea-osmar-9855b6b1/"><i className="fab fa-linkedin" /></a></span>
          <span className='info-icons'><a href="mailto:andrea88@live.se"><i className="far fa-envelope" /></a></span>
